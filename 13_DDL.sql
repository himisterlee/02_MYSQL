...
-- -> 기존에 존재하는 테이블이 있더라도 에러가 발생하진 않는다.
...
-- 기본값으로 들어가게 됨
-- [22001][1292] Data truncation: Incorrect date value: '0000-00-00' for column 'col3' at row 1 발생
alter table tb2
    add col3 date not null;
#    add col4 tinyint not null;

-- mysql 자체에서 전역적인 유효성 검사 모드를 사용한다.
-- ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION 발생
